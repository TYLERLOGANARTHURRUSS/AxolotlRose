...
const SearchAndAdd = ()=>{
    ...
    const searchBooks = () => {
        ...
        axios(`https://www.googleapis.com/books/v1/volumes?q=${search}&key=AIzaSyCG4CetKRxfceKIXmPWjbo5PsOtJ0HOi0U`
            ...
            const books = [];
            books.push([el.volumeInfo.title, el.volumeInfo.authors[0], el.volumeInfo.imageLinks.thumbnail]) 
            
            setResults(results => [...results, <ShowBooks title = {books[0][0]} author={books[0][1]} imgLink = {books[0][2]}/>])
